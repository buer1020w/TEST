			...
			function init() {
				...
				const sprite2 = textureLoader.load( './src/assets/雪花2.png', assignSRGB );
				const sprite3 = textureLoader.load( './src/assets/雪花3.png', assignSRGB );
				const sprite4 = textureLoader.load( './src/assets/雪花4.png', assignSRGB );
